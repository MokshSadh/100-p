           ...
           var utterThis = new SpeechSynthesisUtterance(speak_data);
            synth.speak(utterThis);
             Webcam.attach(camera);
              setTimeout(function() { img_id="selfie1"; take_snapshot(); save() }   , 5000);
      setTimeout(function()
       {
         img_id="selfie2";
          take_snapshot();
                      ...
                      Webcam.snap(function(data_uri)
                       {
                         ...
                         document.getElementById("result2").innerHTML = '<img id="camera-2.jpg" src="'+data_uri+'">';
                           ...
                           if(img_id=="selfie3"){ document.getElementById("result3").innerHTML = '<img id="camera-3.jpg" src="'+data_uri+'">'; 
                        } 
                        }); 
                        }    
                           function save() {
